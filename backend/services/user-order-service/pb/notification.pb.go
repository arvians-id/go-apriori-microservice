...
// 	protoc        v3.21.9
// source: services/user-order-service/proto/notification.proto
...
func (x *ListNotificationResponse) Reset() {
	*x = ListNotificationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_order_service_proto_notification_proto_msgTypes[0]
...
func (*ListNotificationResponse) Descriptor() ([]byte, []int) {
	return file_services_user_order_service_proto_notification_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetNotificationResponse) Reset() {
	*x = GetNotificationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_order_service_proto_notification_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotificationResponse) Descriptor() ([]byte, []int) {
	return file_services_user_order_service_proto_notification_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetNotificationByIdRequest) Reset() {
	*x = GetNotificationByIdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_order_service_proto_notification_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotificationByIdRequest) Descriptor() ([]byte, []int) {
	return file_services_user_order_service_proto_notification_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetNotificationByUserIdRequest) Reset() {
	*x = GetNotificationByUserIdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_order_service_proto_notification_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotificationByUserIdRequest) Descriptor() ([]byte, []int) {
	return file_services_user_order_service_proto_notification_proto_rawDescGZIP(), []int{3}
}
...
func (x *CreateNotificationRequest) Reset() {
	*x = CreateNotificationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_order_service_proto_notification_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateNotificationRequest) Descriptor() ([]byte, []int) {
	return file_services_user_order_service_proto_notification_proto_rawDescGZIP(), []int{4}
}
...
var File_services_user_order_service_proto_notification_proto protoreflect.FileDescriptor

var file_services_user_order_service_proto_notification_proto_rawDesc = []byte{
	0x0a, 0x34, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2d,
	...
	0x69, 0x63, 0x65, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2d,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x53, 0x0a, 0x18, 0x4c, 0x69,
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70,
	...
	0x52, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x2c, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	...
	0x64, 0x22, 0x38, 0x0a, 0x1e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xb3, 0x01, 0x0a, 0x19,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x55, 0x52, 0x4c,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x55, 0x52, 0x4c, 0x12, 0x16, 0x0a, 0x06, 0x49,
	0x73, 0x52, 0x65, 0x61, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x49, 0x73, 0x52,
	0x65, 0x61, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41,
	0x74, 0x32, 0x8d, 0x03, 0x0a, 0x13, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	...
	0x12, 0x25, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x07, 0x4d, 0x61, 0x72, 0x6b, 0x41, 0x6c, 0x6c, 0x12,
	0x25, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	...
	0x0a, 0x04, 0x4d, 0x61, 0x72, 0x6b, 0x12, 0x21, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47,
	...
	0x79, 0x42, 0x22, 0x5a, 0x20, 0x2e, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f,
...
var (
	file_services_user_order_service_proto_notification_proto_rawDescOnce sync.Once
	file_services_user_order_service_proto_notification_proto_rawDescData = file_services_user_order_service_proto_notification_proto_rawDesc
)

func file_services_user_order_service_proto_notification_proto_rawDescGZIP() []byte {
	file_services_user_order_service_proto_notification_proto_rawDescOnce.Do(func() {
		file_services_user_order_service_proto_notification_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_user_order_service_proto_notification_proto_rawDescData)
	})
	return file_services_user_order_service_proto_notification_proto_rawDescData
}

var file_services_user_order_service_proto_notification_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_user_order_service_proto_notification_proto_goTypes = []interface{}{
...
var file_services_user_order_service_proto_notification_proto_depIdxs = []int32{
...
func init() { file_services_user_order_service_proto_notification_proto_init() }
func file_services_user_order_service_proto_notification_proto_init() {
	if File_services_user_order_service_proto_notification_proto != nil {
		return
	}
	file_services_user_order_service_proto_entity_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_services_user_order_service_proto_notification_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_order_service_proto_notification_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_order_service_proto_notification_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_order_service_proto_notification_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_order_service_proto_notification_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_user_order_service_proto_notification_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_user_order_service_proto_notification_proto_goTypes,
		DependencyIndexes: file_services_user_order_service_proto_notification_proto_depIdxs,
		MessageInfos:      file_services_user_order_service_proto_notification_proto_msgTypes,
	}.Build()
	File_services_user_order_service_proto_notification_proto = out.File
	file_services_user_order_service_proto_notification_proto_rawDesc = nil
	file_services_user_order_service_proto_notification_proto_goTypes = nil
	file_services_user_order_service_proto_notification_proto_depIdxs = nil
}
...
var _NotificationService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/user-order-service/proto/notification.proto",
}
